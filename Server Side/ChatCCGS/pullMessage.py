...
#http://tartarus.ccgs.wa.edu.au/~1022309/cgibin/ChatCCGS/pullMessage.py?username=124&password=password1234
...
try:
    ...
    if archive:
        ...
        cur.executemany("INSERT INTO Archived(content,datestamp,authorID,recipientID,groupID,customGroup) VALUES(?,?,?,?,?,?)",[x[1:] for x in data])
